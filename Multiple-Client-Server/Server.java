...
public class Server {
            ...
            try (ServerSocket serverSocket = new ServerSocket(port)) {
                ...
                while(true) {
                    ...
                    if(clientType.equalsIgnoreCase("publisher")){
                        System.out.println(clientType+" "+PublisherNumber+" connected: " + clientSocket.getInetAddress().getHostAddress());
                    }else if(clientType.equalsIgnoreCase("subscriber")){
                        System.out.println(clientType+" "+SubscriberNumber+" connected: " + clientSocket.getInetAddress().getHostAddress());
                    }else{
                    ...
                    if(clientType.equalsIgnoreCase("publisher")){
                        clientHandler = new ClientHandler(clientSocket,clientType,++PublisherNumber);
                    }else if(clientType.equalsIgnoreCase("subscriber")){
                        clientHandler = new ClientHandler(clientSocket,clientType,++SubscriberNumber);
                    }
    ...
    static class ClientHandler extends Thread {
        ...
        public ClientHandler(Socket socket,String clientType,int number) {
